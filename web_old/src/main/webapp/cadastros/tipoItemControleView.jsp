...
<f:view>
    ...
    <h:form prependId="false">
        <table cellspacing="0" border="0" class="boxCreateEdit">
			...
			<tr>
                <td class="boxCreateEditRow" style="padding-bottom: 8px;" colspan="2">
                    <h:selectOneMenu id="Operacao" label="#{msg.tipoItemControleView_tipoItemControle}"
                        ...
                        converter="tipoItemControleConversor"
                        required="true"
			...
			<tr>
                <td class="boxCreateEditRow" colspan="2">
                    <h:outputLabel value="#{msg.tipoItemControleView_metasinternasEmbarque}:" /></td>
            </tr>
            <tr>
				<td class="boxCreateEditRow" style="padding-bottom: 8px;" colspan="2">
					<rich:pickList value="#{tipoItemDeControleController.metaInternaList}"
					    styleClass="boxSelectItem" style="boxSelectItem" sourceListWidth="200px" targetListWidth="200px" 
					    converter="metaInternaConversor" showButtonsLabel="false" required="false" id="metaInternaLista">
						<f:selectItems value="#{tipoItemDeControleController.metaInternaItemList}" />
					</rich:pickList>
				</td>
			</tr>
            ...
            <tr>
                <td class="boxCreateEditRow" colspan="2">
                    <h:outputLabel value="#{msg.tipoItemControleView_metasinternasProducao}:" /></td>
            </tr>
            <tr>
				<td class="boxCreateEditRow" style="padding-bottom: 8px;" colspan="2">
					<rich:pickList value="#{tipoItemDeControleController.metaInternaProducaoList}"
					    styleClass="boxSelectItem" style="boxSelectItem" sourceListWidth="200px" targetListWidth="200px" 
					    converter="metaInternaConversor" showButtonsLabel="false" required="false" id="metaInternaListaProducao">
						<f:selectItems value="#{tipoItemDeControleController.metaInternaProducaoItemList}" />
					</rich:pickList>
				</td>
			</tr>
            ...
            <tr>
                <td class="boxCreateEditRow" colspan="2">
                    <h:outputLabel value="#{msg.tipoItemControleView_regras}:" /></td>
            </tr>
            <tr>
				<td class="boxCreateEditRow" style="padding-bottom: 8px;" colspan="2">
					<rich:pickList value="#{tipoItemDeControleController.regraFarolList}" 
					    styleClass="boxSelectItem" style="boxSelectItem" sourceListWidth="200px" targetListWidth="200px" 
					    converter="regraFarolConversor" showButtonsLabel="false" required="false" id="regraFarolLista" >
						<f:selectItems value="#{tipoItemDeControleController.regraFarolItemList}" />
					</rich:pickList>
				</td>
			</tr>
			<tr>
                <td class="boxCreateEditRow" colspan="2">
                    <h:outputLabel value="#{msg.tipoItemControleView_coeficiente}:" /></td>
            </tr>
            <tr>
				<td class="boxCreateEditRow" style="padding-bottom: 8px;" colspan="2">
					<rich:pickList value="#{tipoItemDeControleController.coeficienteList}" 
                        styleClass="boxSelectItem" style="boxSelectItem" sourceListWidth="200px" targetListWidth="200px" 
					    converter="coeficienteDeDegradacaoConversor" showButtonsLabel="false" required="false" id="coeficienteLista">
						<f:selectItems value="#{tipoItemDeControleController.coeficienteItemList}" />
					</rich:pickList>
				</td>
			</tr>
            <tr>
