            ...
            <tr>
                <td class="boxCreateEditRow" style="padding-bottom: 8px;" colspan="2">
                    <h:selectOneMenu id="estadoOperacao" label="#{msg.pierView_estadoOperacao}"
                        onchange="#{pierController.pier.estado}"
                        converter="estadoEstruturaEnumConversor"
                        value="#{pierController.pier.estado}">          
                        <f:selectItems
            ...
            <tr>
                <td class="box11">      
                    <rich:dataTable width="560" border="0" cellspacing="0"
                            value="#{pierController.pier.listaDeCarregadoraDeNavios}"
                            var="obj" 
	...
	<br>
        ...
        <table cellspacing="0" border="0" class="painelTabela" width="590">
            <tr>
                <td class="box11">      
                    <rich:dataTable width="560" border="0" cellspacing="0"
                            value="#{pierController.pier.listaDeBercosDeAtracacao}"
                            var="obj" 
                            id="berco"
                    ...
                    <table cellspacing="0" border="0">
                        <tr>
                            ...
                            <td style="padding-left: 12px;">
                                <a4j:commandLink action="voltarPier"
                                        immediate="true">
                                    <div class="customButton"
                                        onmouseover="defineButtonStyleOver(this);"
                                        onmouseout="defineButtonStyleOut(this);">
