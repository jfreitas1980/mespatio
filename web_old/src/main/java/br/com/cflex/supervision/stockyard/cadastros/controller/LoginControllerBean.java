...
import br.com.cflex.supervision.stockyard.cadastros.vo.Permission;
import br.com.cflex.supervision.stockyard.cadastros.vo.User;
	 ...
	 private String executarLogin()
	  ...
	  private void loadUser(String xmlContent) throws JAXBException {
	        JAXBContext jaxbContext = JAXBContext
						.newInstance("br.com.cflex.supervision.stockyard.cadastros.vo");
