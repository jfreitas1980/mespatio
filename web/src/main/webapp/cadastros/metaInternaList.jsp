...
<f:view>  
    ...
    <h:form>
        ...
        <br>
        <!-- tabela de tipo-->
        <table cellspacing="0" border="0" class="painelTabela" width="9
        90" style=" width : 882px;">
            <tr>
                <td class="box11">      
                    <rich:dataTable width="860" border="0" cellspacing="0"
                            ...
                            columnClasses="coluna2,coluna2,coluna2,coluna2,coluna3,coluna4,coluna4,coluna4"
                        ...
                        -->
                        <rich:column>      
							<f:facet name="header"><h:outputLabel value="#{msg.tipoItemControleList_titulo}" /></f:facet>
                            <h:outputText value="#{obj.tipoItemDeControle.descricaoTipoItemControle}"/>
                        </rich:column>
                        <rich:column>   
                        ...
                        <rich:column>   
                         ...
                         <rich:column>   
							<f:facet name="header"><h:outputLabel value="#{msg.metaInternaList_dataFim}" /></f:facet>
