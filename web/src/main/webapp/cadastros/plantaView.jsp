    ...
    <h:form prependId="false">
            ...
            <tr>
                <td class="boxCreateEditRow" style="padding-bottom: 8px;">
                    <h:inputText id="nomePlanta" label="#{msg.plantaView_nomePlanta}"
                        value="#{plantaController.plantaPesquisa.nomePlanta}" size="50"
            ...
            <tr>
                <td class="box11">      
                    <rich:dataTable width="460" border="0" cellspacing="0"
                            value="#{plantaController.plantaPesquisa.listaMetaPiers}"
                            var="obj" 
                            id="pier"
        ...
        <table cellspacing="0" border="0" class="painelTabela" width="490">
            <tr>
                <td class="box11">      
                    <rich:dataTable width="460" border="0" cellspacing="0"
                            value="#{plantaController.plantaPesquisa.listaMetaPatios}"
                            var="obj" 
                            id="patio"
	...
	<br>
        ...
        <table cellspacing="0" border="0" class="painelTabela" width="490">
            <tr>
                <td class="box11">      
                    <rich:dataTable width="460" border="0" cellspacing="0"
                            value="#{plantaController.plantaPesquisa.listaMetaCorreias}"
                            var="obj" 
                            id="correia"
	   ...
	   <br>
        ...
        <table cellspacing="0" border="0" class="painelTabela" width="490">
            <tr>
                <td class="box11">      
                    <rich:dataTable width="460" border="0" cellspacing="0"
                            value="#{plantaController.plantaPesquisa.listaMetaUsinas}"
                            var="obj" 
                            id="usina"
