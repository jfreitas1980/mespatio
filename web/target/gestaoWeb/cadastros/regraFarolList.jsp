        ...
        <table cellspacing="0" border="0">
            <tr>
                <td class="iFrameTitle">
                    <h:outputLabel value="#{msg.titulo_lista_regrafarol}" />
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td class="boxSearchUserRow">
                    <h:outputLabel value="#{msg.tipoproduto_lista_regrafarol}" />
                </td>
            </tr>
            <tr>
                <td class="boxSearchUserRow">
					<h:selectOneMenu id="tipoProdutoRegraFarol"
						onchange="#{regraFarolController.regraFarolPesquisa.tipoProduto}"
						converter="tipoProdutoConversor"
						value="#{regraFarolController.regraFarolPesquisa.tipoProduto}">
            ...
            <tr>
                <td class="boxSearchUserRow" style="padding-bottom: 18px; padding-top: 15px;" align="right">
                    <table cellspacing="0" border="0">
                        <tr>
                            <td>
                                <h:commandLink action="#{regraFarolController.buscaPorFiltro}">
                            ...
                            <td style="padding-left: 12px;">
                               <h:commandLink action="#{regraFarolController.limpaFiltro}"
                                   immediate="true">
                                   <div class="customButton"
                                       onmouseover="defineButtonStyleOver(this);"
                                       onmouseout="defineButtonStyleOut(this);">
        ...
        <table cellspacing="0" border="0" class="painelTabela" width="840">
            <tr>
                <td class="box11">      
                    <rich:dataTable width="810" border="0" cellspacing="0"
                    		value="#{regraFarolController.regraFarolList}"
                            var="obj" 
                            id="regraFarolLista"
                            binding="#{regraFarolController.dataTableRegraFarol}"
                            rows="10"
                        ...
                        <rich:column>
							<f:facet name="header"><h:outputLabel value="#{msg.valor_lista_regrafarol}" /></f:facet>
                            <h:outputText value="#{obj.valorRegraFarol}"/>
                        </rich:column>
                        <rich:column>                
							<f:facet name="header"><h:outputLabel value="#{msg.tipoproduto_lista_regrafarol}" /></f:facet>
                            <h:outputText value="#{obj.tipoProduto.descricaoTipoProduto}"/>
                        </rich:column>     
                        <rich:column>
							<f:facet name="header"><h:outputLabel value="#{msg.label_edit}" /></f:facet>
                            <h:commandLink action="#{regraFarolController.alteraRegraFarol}">
                                ...
                                <f:param value="#{obj.idRegraFarol}" name="id" />
                            </h:commandLink>  
                        </rich:column>  
                        <h:column>
							<f:facet name="header"><h:outputLabel value="#{msg.label_delete}" /></f:facet>
                            <a4j:commandLink action="#{regraFarolController.selectItem}" oncomplete="Richfaces.showModalPanel('conf_delete')" reRender="conf_delete">   
                        ...
                        <f:facet name="footer">
                            <rich:datascroller id="lista" renderIfSinglePage="false" for="regraFarolLista" maxPages="20"/>
                        </f:facet>
                    </rich:dataTable>               
                </td>
            </tr>
            <tr>
                <td class="boxAdd" align="right">
                    <a4j:commandLink action="#{regraFarolController.novaRegraFarol}">
    ...
    <rich:modalPanel id="conf_delete" minHeight="110" minWidth="300"   
            ...
            <center>           
               ...
               <h:commandButton id="btnExcluir"
                    ...
                    action="#{regraFarolController.excluiRegraFarol}"
