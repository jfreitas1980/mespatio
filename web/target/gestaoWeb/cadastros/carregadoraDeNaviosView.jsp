...
<f:view>  
    ...
    <h:form>
        <table cellspacing="0" border="0" class="boxCreateEdit">
            ...
            <tr>
                <td class="boxSearchUserRow" style="padding-bottom: 8px;" colspan="2">
					<h:selectOneMenu id="estadoMaquina" label="#{msg.carregadoraDeNaviosView_estadooperacao}"
						onchange="#{carregadoraDeNaviosController.carregadoraSelecionada.estado}"
						converter="estadoMaquinaEnumConversor"
						required="true"
						value="#{carregadoraDeNaviosController.carregadoraSelecionada.estado}">
                        <f:selectItems
            ...
            <tr>
                <td class="boxSearchUserRow" style="padding-bottom: 8px;" colspan="2">
                    <h:inputText id="taxaOperacao" label="#{msg.carregadoraDeNaviosView_taxaoperacao}"
                        value="#{carregadoraDeNaviosController.carregadoraSelecionada.taxaDeOperacao}"
			...
			<tr>
                <td class="boxCreateEditRow" colspan="2">
                    <h:outputLabel value="#{msg.metaInternaList_dataInicio}:" />
                </td>
            </tr>
            <tr>                
                <td class="boxCreateEditRow" style="padding-bottom: 8px;" colspan="2">
					<rich:calendar id="dataInicio" label="#{msg.metaInternaList_dataInicio}"
                        ...
                        value="#{carregadoraDeNaviosController.carregadoraSelecionada.dtInicio}" />
                </td>                
            </tr>
			<tr>			
				<td class="boxCreateEditRow" colspan="2"
