        ...
        <table cellspacing="0" border="0">
            <tr>
                <td class="iFrameTitle">
                    <h:outputLabel value="#{msg.tipoItemControleList_titulo}" />
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td class="boxSearchUserRow">
                    <h:outputLabel value="#{msg.tipoItemControleList_descricao}" />
                </td>
            </tr>
            <tr>
                <td class="boxSearchUserRow">
                    <h:inputText id="NameFilter"
                        value="#{tipoItemDeControleController.tipoItemDeControlePesquisa.descricaoTipoItemControle}"
            ...
            <tr>
                <td class="boxSearchUserRow" style="padding-bottom: 18px; padding-top: 15px;" align="right">
                    <table cellspacing="0" border="0">
                        <tr>
                            <td>
                                <h:commandLink action="#{tipoItemDeControleController.buscaPorFiltro}">
                            ...
                            <td style="padding-left: 12px;">
                               <h:commandLink action="#{tipoItemDeControleController.limpaFiltro}"
                                   immediate="true">
                                   <div class="customButton"
                                       onmouseover="defineButtonStyleOver(this);"
                                       onmouseout="defineButtonStyleOut(this);">
        ...
        <table cellspacing="0" border="0" class="painelTabela" width="840">
            <tr>
                <td class="box11">      
                    <rich:dataTable width="810" border="0" cellspacing="0"
                    	    value="#{tipoItemDeControleController.tipoItemDeControleList}"
                            var="obj" 
                            id="tipoItemControleLista" 
                            rows="10"
                            binding="#{tipoItemDeControleController.dataTableTipoItemDeControle}"
                            styleClass="tabela" style="table-layout:fixed"
                            rowClasses="linhaPar, linhaImpar"
                            columnClasses="coluna1,coluna3,coluna3,coluna3"
                            headerClass="cabecalho">
                        <rich:column>
								<f:facet name="header"><h:outputLabel value="#{msg.tipoItemControleList_descricao}" /></f:facet>
								<h:outputText value="#{obj.descricaoTipoItemControle}"/>
                        </rich:column>
                        <rich:column>    
            				<f:facet name="header"><h:outputLabel value="#{msg.tipoItemControleList_unidade}" /></f:facet>
                            <h:outputText value="#{obj.unidade}"/>
                        </rich:column>
						<rich:column>
  							<f:facet name="header"><h:outputLabel value="#{msg.label_edit}" /></f:facet>
                            <a4j:commandLink action="#{tipoItemDeControleController.alteraTipoItemDeControle}">
                                ...
                                <f:param value="#{obj.idTipoItemDeControle}" name="id" />
                            </a4j:commandLink>  
                        </rich:column>  
                        <h:column>
							<f:facet name="header"><h:outputLabel value="#{msg.label_delete}" /></f:facet>
                            <a4j:commandLink action="#{tipoItemDeControleController.selectItem}" oncomplete="Richfaces.showModalPanel('conf_delete')" reRender="conf_delete">   
                        ...
                        <f:facet name="footer">
                            <rich:datascroller id="lista" renderIfSinglePage="false" for="tipoItemControleLista" maxPages="20"/>
                        </f:facet>
                    </rich:dataTable>               
                </td>
            </tr>
            <tr>
                <td class="boxAdd" align="right">
                    <a4j:commandLink action="#{tipoItemDeControleController.novoTipoItemDeControle}">
    ...
    <rich:modalPanel id="conf_delete" minHeight="110" minWidth="300"   
            ...
            <center>           
               ...
               <h:commandButton id="btnExcluir"
                    ...
                    action="#{tipoItemDeControleController.excluiTipoItemDeControle}"
