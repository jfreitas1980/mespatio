...
/**
 * Painel que apresenta os indices de valor do blend, estimado e embarcado contra a meta interna de producao
 * 
 * @author andre
 *
 */
public class ItemControleBlendadoMetaProducao extends RepresentacaoGrafica {

   /** o item de controle cujos valores estao representados neste painel*/
    private ItemDeControle itemControle;
    
    /** o tipo de pproduto desta meta interna */
    ...
    public ItemControleBlendadoMetaProducao(ItemDeControle itemBlend, TipoProduto tipoProduto, Date dataHoraSituacaoPatio) {
        initComponents();
        ...
        //this.coeficienteDegradacao = ControladorItemDeControle.buscarCoeficienteDegradacaoDoPeriodoDoTipoItemDeControleParaUmDeterminadoTipoProduto(dataHoraSituacaoPatio, this.itemControle, this.tipoProdutoDaMetaInterna);
...
//        montaDesenhoItemBlend();
    ...
    public void montaDesenhoItemBlend() {
        ...
        EnumEstadosDoFarol estadoFarol = interfaceBlendagem.getControladorItemDeControle().determinaEstadoDoFarol(tipoProdutoDaMetaInterna, TipoMetaInternaEnum.META_DE_PRODUCAO, this.dataHoraSituacaoPatio);
        if (estadoFarol != null) {
        ...
        if (coeficienteDegradacao != null && itemControle.getValor() != null)
        {
           ...
           lblEstimado.setBounds(calculaDimensaoBlend(lblVariacoesBlend,  (itemControle.getValor() + (itemControle.getValor() + coeficienteDegradacao.getValorDoCoeficiente()) ), lblEstimado));
      ...
      if (tipoProdutoDaMetaInterna != null)
      {
           ...
           MetaInterna metaInternaDeProducao = interfaceBlendagem.getControladorItemDeControle().buscaMetaInterna(tipoProdutoDaMetaInterna, dataHoraSituacaoPatio, TipoMetaInternaEnum.META_DE_PRODUCAO);
           
         if (metaInternaDeProducao != null)
         {
            Double limiteInferiorValorMetaInterna = metaInternaDeProducao.getLimiteInferiorValorMetaInterna();
            Double limiteSuperiorValorMetaInterna = metaInternaDeProducao.getLimiteSuperiorValorMetaInterna();
            if (limiteSuperiorValorMetaInterna != null && limiteInferiorValorMetaInterna != null)
            {
               if (limiteSuperiorValorMetaInterna.equals(limiteInferiorValorMetaInterna))
               {
                  ...
                  lblMetaUnica.setToolTipText(PropertiesUtil.getMessage("tooltip.controle.blendado.meta.producao") + DSSStockyardFuncoesNumeros.getQtdeFormatada(limiteInferiorValorMetaInterna,2));
               ...
               } else
               {
                  ...
                  value.append(PropertiesUtil.getMessage("tooltip.controle.blendado.faixa.meta.producao")).append(DSSStockyardFuncoesNumeros.getQtdeFormatada(limiteInferiorValorMetaInterna,2)).append(" - ").append(DSSStockyardFuncoesNumeros.getQtdeFormatada(limiteSuperiorValorMetaInterna,2));
                  lblMeta.setToolTipText(value.toString());
                  //lblMeta.setToolTipText(PropertiesUtil.getMessage("tooltip.controle.blendado.faixa.meta.producao") + DSSStockyardFuncoesNumeros.getQtdeFormatada(limiteInferiorValorMetaInterna,2) + " - " + DSSStockyardFuncoesNumeros.getQtdeFormatada(limiteSuperiorValorMetaInterna,2));
   ...
   private void initComponents() {
      ...
      variacaojl = new javax.swing.JLabel();
      ...
      lblPontosEscala.setBounds(0, 10, 360, 20);
      ...
      variacaojl.setText("Unidade");

      jPanel2.setOpaque(false);
      jPanel2.setLayout(null);
      jPanel2.add(lblStatusBlendagem);
      lblStatusBlendagem.setBounds(0, 0, 34, 14);
      ...
      layout.setHorizontalGroup(
         ...
         .addGroup(layout.createSequentialGroup()
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
               .addGroup(layout.createSequentialGroup()
                  .addContainerGap()
                  .addComponent(lblDescricaoItemControle, javax.swing.GroupLayout.PREFERRED_SIZE, 174, javax.swing.GroupLayout.PREFERRED_SIZE)
                  .addGap(18, 18, 18)
                  .addComponent(variacaojl)
                  .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                  .addComponent(lblUnidadeVariacao, javax.swing.GroupLayout.PREFERRED_SIZE, 83, javax.swing.GroupLayout.PREFERRED_SIZE)
                  .addGap(18, 18, 18)
      ...
      layout.setVerticalGroup(
         ...
         .addGroup(layout.createSequentialGroup()
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
               .addGroup(layout.createSequentialGroup()
                  .addGap(5, 5, 5)
                  .addComponent(lblDescricaoItemControle, javax.swing.GroupLayout.PREFERRED_SIZE, 12, javax.swing.GroupLayout.PREFERRED_SIZE))
               .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                  ...
                  .addComponent(variacaojl, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
   ...
   private javax.swing.JLabel variacaojl;
   ...
   private void desenhaBkgQualidade()
   {
    ...
    private void montaEscalaItemControle() {
        jPanel1.add(DefinePropriedadesFixas.getMapaEscalaMetasProducao().get(itemControle.getTipoItemControle().getIdTipoItemDeControle()));
    }
