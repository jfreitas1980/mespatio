...
/**
 * Possíveis sentidos de empilhamento ou recuperação nos pátios
 * 
 * @author andre
 *
 */
public enum SentidoEmpilhamentoRecuperacaoEnum
{  
   /** Sentido do norte(esquerda) para o sul (direita) */
   NORTE_PARA_SUL,
   /** Sentido do sul (direita) para o norte (esquerda) */
   SUL_PARA_NORTE;
